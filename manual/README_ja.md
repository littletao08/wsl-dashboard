...
[简体中文](./README_zh_CN.md) | [繁體中文](./README_zh_TW.md) | [English](../README.md) | 日本語 | [Français](./README_fr.md) | [Español](./README_es.md) | [Русский](./README_ru.md) | [Português](./README_pt.md) | [Deutsch](./README_de.md) | [Italiano](./README_it.md) | [Türkçe](./README_tr.md) | [Bahasa Indonesia](./README_id.md) | [हिन्दी](./README_hi.md) | [বাংলা](./README_bn.md)
...
- 大容量の WSL インスタンス（VHDX）を他のディスクへ移動し、Cドライブの空き容量を確保。
...
- **既存のディストリビューションの管理**：メインビューから任意の WSL ディストリビューションを起動、停止、終了、または登録解除できます。
...
- **保存場所の移動**：大きな VHDX ファイルを別のドライブに移動して、C ドライブの容量を節約できます。
